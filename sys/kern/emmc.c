...
const emmc_cmd_t default_emmc_commands[57] = {
  ...
  [EMMC_CMD_READ_DAT_UNTIL_STOP] =
    {EMMC_CMD_READ_DAT_UNTIL_STOP, 0, EMMCRESP_R1},
  [EMMC_CMD_STOP_TRANSMISSION] =
    {EMMC_CMD_STOP_TRANSMISSION, 0, EMMCRESP_R1},
  ...
  [EMMC_CMD_GO_INACTIVE_STATE] =
    {EMMC_CMD_GO_INACTIVE_STATE, 0, EMMCRESP_NONE},
  ...
  [EMMC_CMD_READ_MULTIPLE_BLOCKS] =
    {EMMC_CMD_READ_MULTIPLE_BLOCKS, EMMC_F_DATA, EMMCRESP_R1},
  [EMMC_CMD_WRITE_DAT_UNTIL_STOP] =
    {EMMC_CMD_WRITE_DAT_UNTIL_STOP, 0, EMMCRESP_R1},
  ...
  [EMMC_CMD_WRITE_MULTIPLE_BLOCKS] = 
    {EMMC_CMD_WRITE_MULTIPLE_BLOCKS, EMMC_F_DATA, EMMCRESP_R1},
  ...
  [EMMC_CMD_SEND_WRITE_PROT_TYPE] =
    {EMMC_CMD_SEND_WRITE_PROT_TYPE, 0, EMMCRESP_R1},
