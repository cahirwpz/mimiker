...
RUN curl -O https://mimiker.ii.uni.wroc.pl/download/qemu-mimiker_5.2.0+mimiker1_amd64.deb && \
    dpkg -i qemu-mimiker_5.2.0+mimiker1_amd64.deb && rm -f qemu-mimiker_5.2.0+mimiker1_amd64.deb
