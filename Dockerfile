...
RUN curl -O https://mimiker.ii.uni.wroc.pl/download/riscv32-mimiker-elf_1.5.3_amd64.deb && \
    dpkg -i riscv32-mimiker-elf_1.5.3_amd64.deb && rm -f riscv32-mimiker-elf_1.5.3_amd64.deb
