...
RUN curl -O https://mimiker.ii.uni.wroc.pl/download/qemu-mimiker_4.2.1+mimiker2_amd64.deb && \
    dpkg -i qemu-mimiker_4.2.1+mimiker2_amd64.deb && rm -f qemu-mimiker_4.2.1+mimiker2_amd64.deb
