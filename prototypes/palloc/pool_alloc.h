...
typedef struct pool_slab {
  ...
  uint16_t ph_nfree;     /* # of free (and available) items, a bit redundant but there would be padding abyway*/
...
void pool_init(pool_t *buf, size_t size, void (*constructor)(void *, size_t), void (*destructor)(void *, size_t));
