...
#define PTE_CACHE_WRITE_THROUGH                                                \
  (0 << PTE_CACHE_SHIFT) /* cacheable, noncoherent, write-through, no write    \
                            allocate */
#define PTE_CACHE_UNCACHED (2 << PTE_CACHE_SHIFT) /* uncached */
#define PTE_CACHE_WRITE_BACK                                                   \
  (3 << PTE_CACHE_SHIFT) /* cacheable, noncoherent, write-back, write allocate \
                          */
#define PTE_CACHE_UNCACHED_ACCELERATED                                         \
  (7 << PTE_CACHE_SHIFT)     /* uncached accelerated */
