...
typedef int fo_read_t(struct file* f, struct thread* td, char* buf, size_t count);
typedef int fo_write_t(struct file* f, struct thread* td, char* buf, size_t count);
...
struct file{
    void* f_data; /* file descriptior specific data */
