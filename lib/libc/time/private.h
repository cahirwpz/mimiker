...
#define HAVE_STDINT_H                                                          \
  (199901 <= __STDC_VERSION__ || 2 < __GLIBC__ + (1 <= __GLIBC_MINOR__) ||     \
...
#define TIME_T_MAX                                                             \
  (TYPE_SIGNED(time_t) ? _Generic((time_t)0, signed char                       \
                                  : SCHAR_MAX, short                           \
                                  : SHRT_MAX, int                              \
                                  : INT_MAX, long                              \
                                  : LONG_MAX, long long                        \
