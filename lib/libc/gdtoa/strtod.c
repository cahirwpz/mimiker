...
static double _int_strtod_l(CONST char *s00, char **se, locale_t loc) {
#ifdef Avoid_Underflow
  int scale;
#endif
#ifdef INFNAN_CHECK
...
#ifndef NO_HEX_FP /*{*/
    {
      static CONST FPI fpi = {53, 1 - 1023 - 53 + 1, 2046 - 1023 - 53 + 1, 1,
                              SI};
      Long expt;
      ULong bits[2];
      switch (s[1]) {
...
#define fpi1 fpi
#endif
          switch ((i = gethex(&s, &fpi1, &expt, &bb, sign, loc)) &
                  STRTOG_Retmask) {
