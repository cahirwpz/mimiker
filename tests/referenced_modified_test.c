...
static int test_ref_mod_action[TEST_REF_MOD_PAGES_NO] = {
  TEST_REF_MOD_STORE, TEST_REF_MOD_NONE, TEST_REF_MOD_NONE,
  TEST_REF_MOD_LOAD,  TEST_REF_MOD_LOAD, TEST_REF_MOD_STORE,
  TEST_REF_MOD_NONE,  TEST_REF_MOD_NONE, TEST_REF_MOD_NONE,
  TEST_REF_MOD_LOAD,  TEST_REF_MOD_NONE, TEST_REF_MOD_STORE,
  TEST_REF_MOD_STORE, TEST_REF_MOD_LOAD, TEST_REF_MOD_STORE,
  TEST_REF_MOD_STORE};
