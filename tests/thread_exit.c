...
static int test_thread_join(void) {
  thread_t *t1 =
    thread_create("test-thread-exit-1", test_thread, &exit_time[0], prio_kthread(0));
  thread_t *t2 =
    thread_create("test-thread-exit-2", test_thread, &exit_time[1], prio_kthread(0));
  thread_t *t3 =
    thread_create("test-thread-exit-3", test_thread, &exit_time[2], prio_kthread(0));
