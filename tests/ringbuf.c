...
static void uio_ringbuf_one_move(void) {
...
static void uio_ringbuf_two_moves(void) {
...
static void uio_ringbuf_turnaround(void) {
...
static int test_ringbuf(void) {
  ringbuf_trivial();
  ringbuf_nontrivial();
  uio_ringbuf_one_move();
  uio_ringbuf_two_moves();
  uio_ringbuf_turnaround();
